...
# In addition, heavily compresses (still lossless compression, no information is lost) the images using ZSTD and horizontal prediction.
# Essentially identical to "write_tfw_metadata_to_tif.sh", just with the following changed gdal_translate.py
#
# Description of write_tfw_metadata_to_tif.sh:
